...
# Taken from nginx-module-vts, whose t/028.upstream_resolve.t this
# repository ports as t/009.upstream_resolve.t.
#
# Copyright (C) 2015, YoungJoo.Kim <vozltx@gmail.com>
# All rights reserved. Redistributed under the BSD 2-clause licence
# that nginx-module-vts is published under; see
